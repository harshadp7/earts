# Generated by Django 2.0 on 2022-03-05 08:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score1', models.CharField(default='0', max_length=10)),
                ('score2', models.CharField(default='0', max_length=10)),
                ('score3', models.CharField(default='0', max_length=10)),
        ...
        migrations.AddField(
            model_name='performance',
            name='judge1',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='j3', to='earts.judges'),
        ),
        migrations.AddField(
            model_name='performance',
            name='judge2',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='j2', to='earts.judges'),
        ),
        migrations.AddField(
            model_name='performance',
            name='judge3',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='j1', to='earts.judges'),
        ),
        migrations.AddField(
